...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp35/weights/last.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--dataset_folder', default='D://test_images', type=str, help='dataset path')
    parser.add_argument('--folder_pict', default='d:/wider_val.txt', type=str, help='folder_pict')
