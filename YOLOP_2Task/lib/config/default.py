...
_C.DATASET.DATAROOT = './database/bdd/bdd100k/images'  # the path of images folder
_C.DATASET.LABELROOT = './database/bdd/bdd100k/labels'  # the path of det_annotations folder
_C.DATASET.MASKROOT = './database/bdd/bdd_seg_gt'  # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = './database/bdd/bdd_lane_gt'  # the path of ll_seg_annotations folder
