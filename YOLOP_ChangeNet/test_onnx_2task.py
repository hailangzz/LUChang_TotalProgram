...
def infer_yolop(weight="./weights/yolop_comme-640-640.onnx",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', type=str, default="yolop_comme-640-640.onnx")
    parser.add_argument('--img', type=str, default="./inference/images/yolop.jpg")
