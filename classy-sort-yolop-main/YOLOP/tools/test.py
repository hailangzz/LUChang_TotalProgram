...
def parse_args():
    ...
    parser.add_argument('--logDir',
                        ...
                        type=str,
                        default='runs/')
    parser.add_argument('--weights', nargs='+', type=str, default=r'E:\Pycharm_Workspace\LUChang_TotalProgram\YOLOP_ChangeNet\runs\BddDataset/final_state.pth', help='model.pth path(s)')
