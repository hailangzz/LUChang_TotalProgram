    ...
    def cache_labels(self, path=Path('./labels.cache')):
        ...
        for i, (im_file, lb_file) in enumerate(pbar):
            try:
                ...
                assert (shape[0] > 9) & (shape[1] > 9), 'images size <10 pixels'
                ...
                nc += 1
                print('WARNING: Ignoring corrupted images and/or label %s: %s' % (im_file, e))
...
def load_mosaic(self, index):
    ...
    indices = [index] + [self.indices[random.randint(0, self.n - 1)] for _ in range(3)]  # 3 additional images indices
